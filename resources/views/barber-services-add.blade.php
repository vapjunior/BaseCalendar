        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="{{ route('barber.services.submit') }}" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <div class="input-group">
                                    <input type="text" class="form-control" id="time" name="time" placeholder="Duração" value="{{ old('time') }}" required autofocus>
